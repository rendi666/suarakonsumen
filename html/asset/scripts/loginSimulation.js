...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateHeader() {
    headerContainer.innerHTML = isLoggedIn
      ? `<a href="kirim-suara.html" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-sk-900 rounded-lg hover:bg-sk-800 focus:ring-4 focus:outline-none focus:ring-sk-300 dark:bg-sk-600 dark:hover:bg-sk-700 dark:focus:ring-sk-800">
